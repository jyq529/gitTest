...
<!-- 					<div class="container-fluid" style="float:left;padding-left:0px;padding-right:0px;"> -->
					
<!-- 						<h3> -->
<!-- 							模块名称区域 -->
<!-- 							<sitemesh:write property='title_area' id="title_area" /> -->
<!-- 						</h3> -->
<!-- 						<div class="panel panel-default container-table" id="orn_main" style="border-radius:0px;"> -->
...
<!-- 									<table class="table table-striped" id="datagrid" style="max-width:100%;background-color:#FDF6F0;" border=0> -->
<!-- 										数据列表区域 -->
