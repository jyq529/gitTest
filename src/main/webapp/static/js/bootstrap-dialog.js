...
(function(root, factory) {
    ...
    BootstrapDialog.defaultOptions = {
        ...
        width:BootstrapDialog.SIZE_NORMAL,
        cssClass: '',
        title: null,
        message: null,
        nl2br: true,
    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function() {
        	...
        	if(width == BootstrapDialog.SIZE_SMALL){
        		return $('<div class="modal-dialog modal-sm"></div>');
        	}else if(width == BootstrapDialog.SIZE_LARGE){
        ...
        createCloseButton: function() {
            var $container = $('<button type="button" class="close btn-remove" data-dismiss="modal"></button>');
