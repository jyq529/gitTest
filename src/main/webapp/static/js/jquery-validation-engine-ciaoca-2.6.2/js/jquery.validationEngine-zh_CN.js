	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"accountName":{
					"regex":/^[_0-9a-zA-Z\u4E00-\u9FA5]+$/,
					"alertText":"* 请输入英文、汉字、数字或下划线"
				},
               "projectName":{
					"regex":/^[_\-0-9a-zA-Z\u4E00-\u9FA5]+$/,
					"alertText":"* 请输入英文、汉字、数字、下划线或\"-\""
				},
				"number":{
				...
				"AppURL":{
					"regex":/^\/[_\-0-9a-zA-Z]+$/,
					"alertText":"* 无效的路径，例：/项目名"
				},
				"interfacePath":{
					"regex":/^(\/[_\-0-9a-zA-Z]+)+[\/?]$/i,
					"alertText":"* 无效的路径，例：/com/sim/manage/controller/"
				},
				"onlyNumberSp":{
					"regex":/^[0-9\ ]+$/,
					"alertText":"* 只能填写数字"
				...
				"mobile":{ 
					"regex":/^0?(13[0-9]|15[012356789]|18[0236789]|14[57])[0-9]{8}$/, /* 正则表达式，如果正则能匹配内容表示通过 */ 
				    "alertText":"无效的手机号" 
				},
				"username":{ 
					"regex":/^[A-Za-z0-9\_]+$/, /* 正则表达式，如果正则能匹配内容表示通过 */ 
					"alertText":"无效的用户名，只能由字母、数字、下划线组成" 
				},
				"password":{ 
					"regex":/^[\@A-Za-z0-9\!\#\$\%\^\&\*\.\~\(\)\-\_\=\+\,\<\>\/\?\;\:\'\"\|]{6,20}$/, /* 正则表达式，如果正则能匹配内容表示通过 */ 
					"alertText":"无效的密码" 
				}
